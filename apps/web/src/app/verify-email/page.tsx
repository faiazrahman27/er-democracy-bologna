    ...
    <AuthShell>
      {status === "loading" ? (
        <div className="grid gap-6" aria-live="polite">
          <MessageBlock tone="neutral">{message}</MessageBlock>

          <div className="h-2 w-full overflow-hidden border border-slate-300/70 bg-white/45 shadow-[inset_0_1px_0_rgba(255,255,255,0.95)] backdrop-blur-[28px]">
            <div className="h-full w-2/3 bg-green-700 shadow-[0_0_44px_rgba(22,163,74,0.40)]" />
          </div>
        </div>
      ) : null}
      ...
      {status === "error" || status === "idle" ? (
        <div className="grid gap-6" aria-live="polite">
          <MessageBlock tone="danger">{message}</MessageBlock>
  ...
  return (
    <AuthShell>
      <div className="grid gap-6">
        <MessageBlock tone="neutral">Verifying your email...</MessageBlock>
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(320px,460px)] lg:items-start">
            <section className="min-w-0">
              ...
              <p className="mt-6 max-w-3xl break-words text-base leading-8 text-slate-600">
                Complete your email verification to activate sign-in access for
  ...
  return (
    <div className="min-w-0">
      ...
      <input
        ...
        className="w-full border border-slate-300/70 bg-white/55 px-3 py-3 text-sm text-slate-950 shadow-[inset_0_1px_0_rgba(255,255,255,0.95),inset_0_-1px_0_rgba(15,23,42,0.08),0_18px_50px_rgba(15,23,42,0.08)] outline-none backdrop-blur-[28px] transition duration-300 placeholder:text-slate-400 hover:border-green-300 hover:bg-white/70 focus:border-green-600 focus:bg-white/80 active:border-green-300 active:bg-white/70"
      />
    </div>
  );
}
